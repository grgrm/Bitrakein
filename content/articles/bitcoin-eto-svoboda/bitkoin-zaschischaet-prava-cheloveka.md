...
categories: ["Биткоин и права человека", "Биткоин = свобода"]
---
...
> Примечание Bitrakein: мы писали статью о том, что такое Фиатные деньги, прочитать нужно обязательно и сделать это можно **[здесь](/chto-takoe-denjgi/)**.
...
> Примечание Bitrakein: Читайте нашу статью **[здесь](/bitcoin-not-crypto/)** почему Биткоин это не "крипта"

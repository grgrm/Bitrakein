...
Цифровые валюты центральных банков - ЦВЦБ/CBDC - это новый масштабный эксперимент, проводимый правительствами большинства стран мира. Цель CBDC - перевести фиатные деньги (доллары, евро, рубли и т. д.) в цифровую форму и отказаться от наличных, что якобы принесет такие преимущества, как снижение затрат и удобство в работе пользователей. Однако под этими утверждениями скрывается зловещая сторона CBDC, в которой правительства осуществляют полный контроль над финансовой системой.
...
Для того чтобы простые граждане могли правильно противостоять росту цифровых валют, они должны быть вооружены информацией о том, что их местные власти говорят об этом и CBDC Tracker нацелен именно на это. Приоткрыть завесу над правительственными экспериментами и мотивами, связанными с CBDC.

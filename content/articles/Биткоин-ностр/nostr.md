...
> ***Мы уже подготовили для вас информацию по сети Lightning, что это такое и какие использовать сервисы, поддерживающие сеть второго уровня. Обязательно [ознакомьтесь тут](https://bitrakein.org/articles/лайтнинг/).***
